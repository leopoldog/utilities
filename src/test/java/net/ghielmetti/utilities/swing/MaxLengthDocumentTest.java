...
/**
 * Tests for {@link MaxLengthDocument}
 *
 * @author lghi
 */
public class MaxLengthDocumentTest {
  /**
   * @throws BadLocationException
   */
  @Test
  public void testOK() throws BadLocationException {
    MaxLengthDocument document1 = new MaxLengthDocument(12);
    MaxLengthDocument document2 = new MaxLengthDocument(-1);
