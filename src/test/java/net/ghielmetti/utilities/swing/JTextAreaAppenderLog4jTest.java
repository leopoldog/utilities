 ...
 */
public class JTextAreaAppenderLog4jTest extends JFrame {
  /** Tests {@link JTextAreaAppender}. */
  @Test
  // This test is ignored because it conflicts with the Logback Appender,
  // test it manually after commenting the logback in the pom file.
  @Ignore
  public void testOK() {
    setLayout(new GridBagLayout());
    Logger textArea1 = LoggerFactory.getLogger("");
    Logger textArea2 = LoggerFactory.getLogger("LogTextArea2log4j");
    JTextAreaPanel panel1 = JTextAreaAppender.getTextAreaPanel("textArea1log4j");
    JTextAreaPanel panel2 = JTextAreaAppender.getTextAreaPanel("textArea2log4j");
